...
public class CMIAdvancement {
    ...
    public CMIAdvancement add() {
        try {
            CMI.getInstance().getNMS().loadAdvancement(id, getJSON());
    ...
    public static class AdvancementBuilder {
        ...
        public AdvancementBuilder customModelData(int modelData) {
        ...
        public CMIAdvancement build() {
            return new CMIAdvancement(id, parent, icon, data, background, title, description, frame, announce, toast, hidden, modelData);
        }
    }
}
