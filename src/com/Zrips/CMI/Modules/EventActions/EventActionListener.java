...
public class EventActionListener implements Listener {
    ...
    public void PlayerKickEvent(PlayerKickEvent event) {
        plugin.getEventActionManager().performCommands(eventAction.playerKick, event.getPlayer());
    }

    @EventHandler(priority = EventPriority.MONITOR, ignoreCancelled = true)
    public void CMIPlayerBanEvent(CMIPlayerBanEvent event) {
        plugin.getEventActionManager().performCommands(eventAction.playerBan, Bukkit.getPlayer(event.getBanned()));
    }
