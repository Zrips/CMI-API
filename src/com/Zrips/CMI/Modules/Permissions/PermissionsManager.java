...
//	command_tfly_give("Allows to give tfly for some one else"),
        ...
        public PermissionInfo getPermissionInfo(Player player, String... extra) {
            return CMI.getInstance().getPermissionsManager().getPermissionInfo(player, this, extra);
        }
    ...
    public PermissionInfo getPermissionInfo(Player player, CMIPerm perm, String... extra) {
        String permString = perm.getPermission(extra);
        return getPermissionInfo(player, permString, 1000L);
    }
